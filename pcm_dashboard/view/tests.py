...
class TemperatureTestsPage(ctk.CTkFrame):
    def __init__(self, parent) -> None:
        ...
        columns = ["Date", "Material", "Peak Temperature", "Duration", "Status"]
        ...
        rows = [
            ("2026-03-10", "Coconut Oil", "33.2°C", "42 min", "Completed"),
            ("2026-03-08", "Paraffin", "31.1°C", "38 min", "Completed"),
            ("2026-03-05", "Beeswax", "29.4°C", "45 min", "Paused"),
        ]
